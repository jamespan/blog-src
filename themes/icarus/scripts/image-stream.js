...
if (hexo.config.image_stream) {
	for (var key in config) {
		if (hexo.config.image_stream[key] != null) {
			...
			console.log(hexo.config.image_stream[key]);
		}
	}
}
...
hexo.extend.tag.register('figure', function(args){
	...
	var result = '<figure>';
	result += '<img class="lazy nofancy" src="' + placeholder + '" data-original="' + imgUrl + '"/>';
